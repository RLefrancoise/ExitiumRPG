<?php if (!defined('IN_PHPBB')) exit; ?><tr valign="middle" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>">
	<td colspan="2">
		...
		var help_line = {
			...
			e: '<?php echo ((isset($this->_rootref['LA_BBCODE_LISTITEM_HELP'])) ? $this->_rootref['LA_BBCODE_LISTITEM_HELP'] : ((isset($this->_rootref['L_BBCODE_LISTITEM_HELP'])) ? addslashes($this->_rootref['L_BBCODE_LISTITEM_HELP']) : ((isset($user->lang['BBCODE_LISTITEM_HELP'])) ? addslashes($user->lang['BBCODE_LISTITEM_HELP']) : '{ BBCODE_LISTITEM_HELP }'))); ?>',
