<?php if (!defined('IN_PHPBB')) exit; ?><form method="post" action="<?php echo (isset($this->_rootref['U_QR_ACTION'])) ? $this->_rootref['U_QR_ACTION'] : ''; ?>">
	...
	<table class="tablebg" width="100%" cellspacing="1">
	    <tr>
		    <td class="cats" colspan="2" align="center"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="row2" valign="top" align="left" width="78%"><textarea name="message" rows="7" cols="76" tabindex="3"  style="height: 130px;width: 98%;"></textarea> </td>
		</tr>
		<tr>
		    <td class="cati" colspan="2" align="center">&nbsp;</td>
		</tr>	
		<tr>
