...
<tr>
	...
	<tr>
		<td class="cat1" width="40%" align="center"><h4><?php echo ((isset($this->_rootref['L_USER_PRESENCE'])) ? $this->_rootref['L_USER_PRESENCE'] : ((isset($user->lang['USER_PRESENCE'])) ? $user->lang['USER_PRESENCE'] : '{ USER_PRESENCE }')); ?></h4></td>
		<td class="catdiv" width="60%" align="center"><h4><?php echo ((isset($this->_rootref['L_USER_FORUM'])) ? $this->_rootref['L_USER_FORUM'] : ((isset($user->lang['USER_FORUM'])) ? $user->lang['USER_FORUM'] : '{ USER_FORUM }')); ?></h4></td>
	</tr>
	<tr>
			...
			<?php if ($this->_rootref['S_SHOW_ACTIVITY']) {  ?>
				...
				<tr>
					...
					<td><?php if ($this->_rootref['ACTIVE_TOPIC'] != ('')) {  ?><b><a class="gen" href="<?php echo (isset($this->_rootref['U_ACTIVE_TOPIC'])) ? $this->_rootref['U_ACTIVE_TOPIC'] : ''; ?>"><?php echo (isset($this->_rootref['ACTIVE_TOPIC'])) ? $this->_rootref['ACTIVE_TOPIC'] : ''; ?></a></b><br /><span class="genmed">[ <?php echo (isset($this->_rootref['ACTIVE_TOPIC_POSTS'])) ? $this->_rootref['ACTIVE_TOPIC_POSTS'] : ''; ?> / <?php echo (isset($this->_rootref['ACTIVE_TOPIC_PCT'])) ? $this->_rootref['ACTIVE_TOPIC_PCT'] : ''; ?> ]</span><?php } else { ?><span class="gen">-</span><?php } ?></td>
                                ...
                                <tr>
					<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap">Fiche RPG : </td>
					<td width="100%"><b class="gen"><a href="<?php echo (isset($this->_rootref['U_RPG_INFO'])) ? $this->_rootref['U_RPG_INFO'] : ''; ?>">Voir la fiche</a></b></td>
				</tr>
			<?php } ?>
	...
	<tr>
		<td class="cat1" align="center"><h4><?php echo ((isset($this->_rootref['L_CONTACT_USER'])) ? $this->_rootref['L_CONTACT_USER'] : ((isset($user->lang['CONTACT_USER'])) ? $user->lang['CONTACT_USER'] : '{ CONTACT_USER }')); ?></h4></td>
		<td class="catdiv" align="center"><h4><?php echo ((isset($this->_rootref['L_ABOUT_USER'])) ? $this->_rootref['L_ABOUT_USER'] : ((isset($user->lang['ABOUT_USER'])) ? $user->lang['ABOUT_USER'] : '{ ABOUT_USER }')); ?></h4></td>
	</tr>
	<tr>
		<td class="row1">
			<table width="100%" cellspacing="1" cellpadding="2" border="0">
	...
	<?php if ($this->_rootref['SIGNATURE']) {  ?>
		...
		<tr>
			<td class="cat1" colspan="2" align="center"><h4><?php echo ((isset($this->_rootref['L_SIGNATURE'])) ? $this->_rootref['L_SIGNATURE'] : ((isset($user->lang['SIGNATURE'])) ? $user->lang['SIGNATURE'] : '{ SIGNATURE }')); ?></h4></td>
		</tr>
		<tr>
