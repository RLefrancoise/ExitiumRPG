	...
	<?php } else { ?>
			...
			<td width="100%" height="25">
				...
				<?php } ?>
					...
					<td class="gensmall" width="100%"><div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>;">&nbsp;<b><?php echo ((isset($this->_rootref['L_POST_SUBJECT'])) ? $this->_rootref['L_POST_SUBJECT'] : ((isset($user->lang['POST_SUBJECT'])) ? $user->lang['POST_SUBJECT'] : '{ POST_SUBJECT }')); ?>:</b> <a href="#p<?php echo $_postrow_val['POST_ID']; ?>"><?php echo $_postrow_val['POST_SUBJECT']; ?></a></div><div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;"><?php if ($this->_rootref['S_IS_BOT']) {  echo $_postrow_val['MINI_POST_IMG']; } else { ?><a href="<?php echo $_postrow_val['U_MINI_POST']; ?>"><?php echo $_postrow_val['MINI_POST_IMG']; ?></a><?php } ?><b><?php echo ((isset($this->_rootref['L_POSTED'])) ? $this->_rootref['L_POSTED'] : ((isset($user->lang['POSTED'])) ? $user->lang['POSTED'] : '{ POSTED }')); ?>:</b> <?php echo $_postrow_val['POST_DATE']; ?>&nbsp;</div></td>
				</tr>
				</table>
			</td>
		</tr>
		...
		<?php if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
			...
			<?php if ($_postrow_val['ONLINE_IMG']) {  ?>
				...
				<tr>
					<td class="online"><?php echo $_postrow_val['ONLINE_IMG']; ?></td>
				</tr>
			...
			<?php } if ($_postrow_val['RANK_IMG']) {  ?>
				...
				<tr>
					<td class="rank"><?php echo $_postrow_val['RANK_IMG']; ?></td>
				</tr>
			<?php } if ($_postrow_val['POSTER_AVATAR']) {  ?>

				<tr>
					<td class="avatar"><?php echo $_postrow_val['POSTER_AVATAR']; ?></td>
				</tr>
...
<?php }} if (! $this->_rootref['S_IS_BOT']) {  ?>
	...
	<tr>
		<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>" valign="middle" nowrap="nowrap">
		<?php if (! $this->_rootref['S_IS_BOT']) {  if ($this->_rootref['S_DISPLAY_POST_INFO']) {  ?><a href="<?php echo (isset($this->_rootref['U_POST_NEW_TOPIC'])) ? $this->_rootref['U_POST_NEW_TOPIC'] : ''; ?>"><?php echo (isset($this->_rootref['POST_IMG'])) ? $this->_rootref['POST_IMG'] : ''; ?></a>&nbsp;<?php } if ($this->_rootref['S_DISPLAY_REPLY_INFO']) {  ?><a href="<?php echo (isset($this->_rootref['U_POST_REPLY_TOPIC'])) ? $this->_rootref['U_POST_REPLY_TOPIC'] : ''; ?>"><?php echo (isset($this->_rootref['REPLY_IMG'])) ? $this->_rootref['REPLY_IMG'] : ''; ?></a><?php } if ($this->_rootref['S_DISPLAY_PVP']) {  ?><a href="<?php echo (isset($this->_rootref['U_POST_PVP'])) ? $this->_rootref['U_POST_PVP'] : ''; ?>">Défier un joueur</a><?php } if ($this->_rootref['S_DISPLAY_KARMA']) {  ?><a href="<?php echo (isset($this->_rootref['U_POST_KARMA'])) ? $this->_rootref['U_POST_KARMA'] : ''; ?>">Fin du RP</a><?php } } ?>
