...
<tr>
	...
	<td class="row2" valign="top">
		...
		<tr>
			<td valign="top" style="width: 100%;"><textarea name="message" rows="15" cols="76" tabindex="3" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();" style="height: 270px;width: 98%;"><?php echo (isset($this->_rootref['MESSAGE'])) ? $this->_rootref['MESSAGE'] : ''; ?></textarea></td>
...
<?php } if ($this->_rootref['CAPTCHA_TEMPLATE'] && $this->_rootref['S_CONFIRM_CODE']) {  $this->_tpldata['DEFINE']['.']['CAPTCHA_TAB_INDEX'] = 4; if (isset($this->_rootref['CAPTCHA_TEMPLATE'])) { $this->_tpl_include($this->_rootref['CAPTCHA_TEMPLATE']); } } if ($this->_rootref['S_SHOW_ATTACH_BOX'] || $this->_rootref['S_SHOW_POLL_BOX']) {  ?>
<tr>
...
<tr>
	...
	<?php } } if ($this->_rootref['CAPTCHA_TEMPLATE'] && $this->_rootref['S_CONFIRM_CODE'] && ! $this->_rootref['S_SHOW_POLL_BOX']) {  ?>	
<tr>
	<td class="cati" colspan="2"></td>
</tr>
<?php } ?>
