...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> "<div style='text-align:center'><p style='font-weight:bold;font-size:20px'>Bonjour !</p><br><br>

<p style='font-style:italic'>Tout d'abord, nous vous remercions pour l'intérêt porté à notre forum. Nous espérons sincèrement que vous vous amuserez parmi nous. Mais avant toute chose, il est primordial de lire quelques uns de nos topics, que ça soit pour connaître les règlements ou encore notre système, ce qui est obligatoire avant de se créer un personnage dans le flou total.</p><br><br>

<p style='color:#40BF00;font-weight:bold'>Les règlements se trouvent ici :</p><br><br>

<a href='http://exitium-rpg.com/viewforum.php?f=6'>http://exitium-rpg.com/viewforum.php?f=6</a><br><br>

<p style='color:#40BF00;font-weight:bold'>L'histoire, ici :</p><br><br>

<a href='http://exitium-rpg.com/viewforum.php?f=7'>http://exitium-rpg.com/viewforum.php?f=7</a><br><br>

<p style='color:#40BF00;font-weight:bold'>Les règles liées aux fiches de personnage :</p><br><br>

<a href='http://exitium-rpg.com/viewtopic.php?f=8&t=14'>http://exitium-rpg.com/viewtopic.php?f=8&t=14</a><br><br>

<p style='color:#40BF00;font-weight:bold'>Et tout ce qui se rapporte au gameplay d'Exitium est là :</p><br><br>

<a href='http://exitium-rpg.com/viewforum.php?f=9'>http://exitium-rpg.com/viewforum.php?f=9</a><br><br>

<p style='font-style:italic'>Il est <span style='color:#FF0000;font-weight:bold'>vivement</span> conseillé d'au moins lire le topic des Rangs, afin d'en choisir un quand vous ferez votre fiche de personnage. Plus tard, si un point du gameplay vous échappe, il y a de fortes chances que vous trouviez votre réponse dans cette même catégorie.</p><br><br>

<p style='font-weight:bold'>Nous vous souhaitons une bonne continuation, nous nous verrons d'ici peu !</p></div><br><br>" . 'En accédant à « %1$s » (désigné ici par « nous », « notre », « nos », « %1$s », « %2$s »), vous acceptez d’être légalement responsable des conditions suivantes. Si vous n’acceptez pas d’être légalement responsable de toutes les conditions suivantes, veuillez ne pas utiliser et/ou accéder à « %1$s ». Nous pouvons modifier ces conditions à n’importe quel moment et nous essaierons de vous informer de ces modifications, bien que nous vous conseillons de vérifier régulièrement cela par vous-même car si vous continuez à participer à « %1$s » après que les modifications aient été effectuées, vous acceptez d’être légalement responsable des conditions modifiées et/ou mises à jour.<br />
	<br />
