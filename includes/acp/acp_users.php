...
//include_once(__DIR__ . '/../../rpg/database/RPGPlayers.class.php');
					...
					if ($delete && $user_row['user_type'] != USER_FOUNDER)
					{
						...
						if ($delete_type)
						{
							if (confirm_box(true))
							{
								...
								if($player !== null and RPGPlayers::deletePlayer(RPGUsersPlayers::getPlayerByUserId($user_id)->getId()) === false)
								{
									trigger_error('La suppression des données de joueur de ce compte a échoué !', E_USER_ERROR);
								}*/
								/* RPG MODIF FIN */
