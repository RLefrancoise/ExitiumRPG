...
//include_once(__DIR__ . '/../rpg/database/RPGUsersPlayers.class.php');
...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
	...
	$template->assign_vars(array(
		...
		'LASTDAY_USER_LIST'		=> get_lastday_users(), //ajout ici
		...
		// END mChat Mod
		// RPG
		'U_RPG_STATUS'			=> append_sid("{$phpbb_root_path}viewstatus.$phpEx"),
		'U_RPG_INN'				=> append_sid("{$phpbb_root_path}viewinn.$phpEx"),
		'U_RPG_MARKET'			=> append_sid("{$phpbb_root_path}viewblackmarket.$phpEx"),
		'U_RPG_CLAN'			=> append_sid("{$phpbb_root_path}viewclan.$phpEx"),
		'U_RPG_MAP'				=> append_sid("{$phpbb_root_path}viewmap.$phpEx"),
		'U_RPG_WAREHOUSE'		=> append_sid("{$phpbb_root_path}viewwarehouse.$phpEx"),
		'U_RPG_ACHIEVEMENTS'	=> append_sid("{$phpbb_root_path}viewachievements.$phpEx"),
		// end RPG
