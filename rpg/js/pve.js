...
function attack() {
	...
	xhr.open("GET", "battlemanagement.php?sid=" + SID + "&mode=pve&a=attack", true);
	xhr.send(null);
}
...
function defend() {
	...
	xhr.open("GET", "battlemanagement.php?sid=" + SID + "&mode=pve&a=defend", true);
	xhr.send(null);
}
...
function skill(skill_nb) {
	...
	xhr.open("GET", "battlemanagement.php?sid=" + SID + "&mode=pve&a=skill&s=" + skill_nb, true);
	xhr.send(null);
...
function item(item_slot) {
	...
	xhr.open("GET", "battlemanagement.php?sid=" + SID + "&mode=pve&a=item&i=" + item_slot, true);
	xhr.send(null);
}
...
function run() {
	...
	if(c == true) {
		...
		xhr.open("GET", "battlemanagement.php?sid=" + SID + "&mode=pve&a=run", true);
		xhr.send(null);
	} else {
		can_perform_action = true;
	}
...
function open_skill_menu(event) {
	...
	xhr.open("GET", "battlemanagement.php?sid=" + SID + "&mode=skill_menu&bm=pve", true);
	xhr.send(null);
}