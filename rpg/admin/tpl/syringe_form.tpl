...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr" xml:lang="fr">
	<head>
		...
		<title>Exitium - Ajout et Edition de seringue</title>
	...
	<body onload="javascript:set_sid('{SID}');javascript:set_mode('{MODE}');javascript:set_root('{ROOT}');javascript:get_items_icons();">
		...
		<div style="width:1280px;margin:auto;text-align:center">
			<h2>Ajout et Modification de seringue</h2>
			
			<form autocomplete="on" action="item_action.php?mode={MODE}&type=syringe" method="post">
				<fieldset>
				...
				<label for="items_images">Image : </label><select id="items_images" name="item_images" onchange="javascript:set_item_picture('{ROOT}');"></select><br>
				...
				<label for="max_pv">Max PV : </label><input type="text" id="max_pv" name="max_pv" value="{MAX_PV}"></input><br>
				<label for="pf">PF : </label><input type="text" id="pf" name="pf" value="{PF}"></input><br>
				<label for="max_pf">Max PF : </label><input type="text" id="max_pf" name="max_pf" value="{MAX_PF}"></input><br>
				...
				<label for="outside">Utilisable hors combat : </label><input type="checkbox" id="outside" name="outside" value="usable" {OUTSIDE_CHECKED}><br>
				<input type="hidden" id="item_id" name="item_id" value="{ID}"></input>
				</fieldset>
