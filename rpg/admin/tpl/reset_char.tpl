...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr" xml:lang="fr">
	<head>
		...
		<title>Exitium - Reset d'un personnage</title>
	...
	<body onload="javascript:set_sid('{SID}');">
		...
		<div style="width:800px;margin:auto;text-align:center">
			<h2>Reset d'un personnage</h2>
			
			<form autocomplete="off" action="reset_char.php" method="post">
				
				<label for="characters">Choisir le personnage : </label>
